                ...
                <div className="flex items-end justify-center min-h-[800px]
                    sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        <Transition.Child 
                            ...
                            leaveTo="opacity-0"
                        >
                                <Dialog.Overlay className="fixed inset-0 bg-gray-600
                                    ...
                                    <div className="">
                                        {selectedFile ? (
                                            ...
                                            <div 
                                                ...
                                                rounded-full bg-red-100 border border-red-400 cursor-pointer"
                                            >
                                                <CameraIcon className='h-8 w-8 text-red-600' aria-hidden='true' />
                                            </div>
                                        )}
